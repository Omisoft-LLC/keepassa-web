                ...
                <tr>
                    <td width="100%">
                        <table bgcolor="#e8eaed" width="600" align="center" cellspacing="0" cellpadding="0" border="0" class="devicewidth">
                            ...
                            <tr>
                                <!-- start of image -->
                            <#--<#list asd as reference>-->
                                <td align="center">
                                    <a target="_blank" href="https://keepassa.co">
                                        <#if info.logo??>
                                        <img width="600" border="0" height="150" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="cid:${info.logo}" class="logo"></a>
                                        <#else>
                                        Keepassa.co
                                        </#if>
